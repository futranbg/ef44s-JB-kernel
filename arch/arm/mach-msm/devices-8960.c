...
/* GSBI 6 used into UARTDM Mode */ // CONFIG_BRCM_BT
...
struct platform_device msm8960_device_qup_i2c_gsbi9 = {
	.name		= "qup_i2c",
	.id		= 9,	//0, djjeon 20121112 modyfiy   0 -> 9
...
#else
	[47] = MSM_GPIO_TO_INT(58),
	[48] = MSM_GPIO_TO_INT(54),
	[49] = MSM_GPIO_TO_INT(52),
	[50] = MSM_GPIO_TO_INT(49),
	[51] = MSM_GPIO_TO_INT(40),
	[52] = MSM_GPIO_TO_INT(37),
	[53] = MSM_GPIO_TO_INT(24),
	[54] = MSM_GPIO_TO_INT(14),
#endif	
};
